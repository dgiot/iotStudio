#!/usr/bin/env python3
"""读取 CommBridge 窗口信息——寻找调试/收发数据窗口"""
import os, sys
...
# 用 PowerShell 列出 CommBridge 进程的所有窗口
ps_script = r'''
Add-Type @"
using System;
...
$cbPid = (Get-Process CommBridge -ErrorAction SilentlyContinue | Select -First 1).Id
if (-not $cbPid) { Write-Host "CommBridge not running"; exit }
