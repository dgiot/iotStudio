...
ps_script = r'''
$etl = "C:\Users\Administrator\rtdb_cap2.etl"
...
netsh trace convert $etl dump=csv tracefile=C:\Users\Administrator\rtdb_cap2.csv 2>&1
Write-Host "CSV created: $((Get-Item 'C:\Users\Administrator\rtdb_cap2.csv').Length) bytes"
'''
...
# Read CSV
print("\n=== CSV header ===")
r = s.run_cmd(r'cmd /c type C:\Users\Administrator\rtdb_cap2.csv 2>nul | more +1 | findstr /N "." | findstr "^[1-9]:" ')
