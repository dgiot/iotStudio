...
# Provider=OraOLEDB.Oracle.1;Password=industrya11_PASS;User ID=INDUSTRYPROD;Data Source=orcl
CONN = r"Provider=OraOLEDB.Oracle.1;Password=industrya11_PASS;Persist Security Info=True;User ID=INDUSTRYPROD;Data Source=orcl"
