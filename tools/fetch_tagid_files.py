...
# List files
r = s.run_cmd(r'cmd /c dir "E:\IO ServerOnLine\run\*pSpace*" "E:\IO ServerOnLine\run\*pPluse*" 2>nul')
print("=== Files ===")
print(r.std_out.decode('gbk', errors='ignore').strip())

# Read pSpace.dat via PowerShell and transfer as base64
ps = r'''
$path = "E:\IO ServerOnLine\run\TagID_IOCommitDB0_pSpace.dat"
