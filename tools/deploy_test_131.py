...
from src.protocols.commbridge_server import LegacyCommServer, crc16
...
async def main():
    ...
    # 清理 - 移除 portproxy
    print(f"\n  清理端口转发...")
    s.run_cmd('netsh interface portproxy delete v4tov4 listenport=53002 listenaddress=192.168.10.131')
