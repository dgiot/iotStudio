...
from src.protocols.commbridge_server import (
    CommBridgeServer, parse_registration, build_read_query,
...
async def main():
    print("=" * 60)
    print("CommBridge 全链路模拟 — 真实协议")
    print("=" * 60)
    print()

    # 1. 启动 CommBridge Server
    server = CommBridgeServer(port=53002, poll_interval=1.5, heartbeat_timeout=30)
    await server.start()
    print(f"  [SRV] CommBridgeServer :53002 started\n")
