#!/usr/bin/env python3
"""探测 RTDB IO Server 协议 + 本地 1:1 模拟"""
...
for extra_id in ["02105110008", "02106290052", "02106290085", "02107010048",
                 ...
                 "02110110045", "DEVICE_ID_PLACEHOLDER", "02110150030", "DEVICE_ID_PLACEHOLDER2",
    ...
    def _handle(self, conn, addr):
        ...
        try:
            while self.running:
                ...
                while len(buf) >= 8:
                    # RTDB 协议: [4B len LE] [4B cmd LE] [payload]
