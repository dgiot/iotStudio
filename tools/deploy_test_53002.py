#!/usr/bin/env python3
"""
CommBridge TCP Server — 53002 端口部署测试
============================================
...
from src.protocols.commbridge_server import (
    CommBridgeServer, crc16, make_modbus_rtu_request,
...
class LiveDashboard:
    ...
    def print_stats(self):
        ...
        print("\n" + "=" * 70)
        print(f"  CommBridge TCP Server :53002  —  运行 {elapsed:.0f}秒")
        print("=" * 70)
...
async def main():
    print("=" * 70)
    print("  CommBridge TCP Server — :53002 部署测试")
    print("  模拟 5 台油田保护装置, 30 秒持续采集")
    print("=" * 70)
