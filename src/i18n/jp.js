export default {
  dgiotI18n: {
    ...
    pressure: {
      ...
      开始时间: '開始時間',
      结束时间: '終了時間',
      压测任务状态: 'ストレステストタスクのステータス',
      压测任务停止: 'ストレス測定タスクが停止しました',
      压测任务启动: 'ストレス測定タスクが開始しました',
      请输入压测任务名: 'ストレステストタスク名を入力してください',
      压测列表: '圧力テストリスト',
      评级: '評価',
      压测启停: '圧力テストの開始と停止',
      压测任务: 'ストレステストタスク',
      ...
      删除任务: '削除',
      您确认要手动开始该压测任务吗:
        'ストレステストタスクを手動で開始してもよろしいですか',
      压测任务已停止: 'ストレステストタスクは停止しました',
      压测任务已启动: 'ストレステストタスクは開始しました',
      zeta压测报告: 'Zeta圧力テストレポート',
      克隆任务成功: 'クローンタスクは成功しました',
      任务删除成功: 'タスクは削除されました',
      暂未配置: '配置されていません',
      确定: 'もちろん',
      设备位置更新成功: 'デバイスの場所が正常に更新されました',
      取消: 'キャンセル',
      你确定要删除当前项吗: '現在の項目を削除してもよろしいですか',
      暂未配置语言类型为: '言語タイプが配置されていません',
      的: 'の',
      表单: 'フォーム',
      关闭: '閉鎖',
      关键词: 'キャンセル',
