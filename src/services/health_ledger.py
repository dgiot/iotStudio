...
绑定场景: 示例采油二厂(南4联合站等) / 采油三厂(北9注水站等)
...
用法:
  ledger = HealthLedger()
  ledger.add_server("192.168.10.131", "采油二厂-南4联合站", scan_data={...})
  ledger.add_server("192.168.10.130", "采油二厂-北9注水站", scan_data={...})
...
def _selftest():
    ...
    ledger = HealthLedger()
    ledger.add_server("192.168.10.131", "南4联合站", "采油二厂-第四作业区",
                      scan_data=healthy)
    ledger.add_server("192.168.10.130", "北9注水站", "采油三厂-第八作业区",
                      scan_data=risky)
    ledger.add_server("192.168.10.129", "萨北21站", "采油三厂-第八作业区",
                      scan_data=caution)
