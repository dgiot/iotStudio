...
class EntityIndex:
    ...
    def build(self, engine: OntologyEngine):
        ...
        _aliases = {
            "ch_a11_rtu": "A11 A11通道 A11采集 功图采集 RTU通道 中石油协议",
...
class LiveContextStore:
    ...
    用法:
      ...
      snap = live.device_snapshot("dev_well_K1_51")
      # → {"device_id":"dev_well_K1_51", "points": [
...
请根据以上摘要回答用户问题。如果数据不足以回答，请说明需要哪些额外信息。"""
    ...
    def ask(self, question: str) -> Dict[str, Any]:
        ...
        protocols_mentioned = [p for p in ['modbus','opc','a11','iec104','s7','dtu','oracle','pspace']
...
def main():
    ...
    用法:
      python -m src.graphrag "K1_51 井的套压安全吗？"
