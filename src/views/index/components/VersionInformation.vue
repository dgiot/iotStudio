          ...
          <td colspan="3">
            <el-popover trigger="hover" width="400">
              <div style="text-align: center">
                <el-image
                  src="http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/platform/assets/skm.jpg"
                  style="width: 200px"
                />
            ...
            <el-popover trigger="hover" width="400">
              <div style="text-align: center">
                <el-image
                  src="http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/platform/assets/skm3.jpg"
                  style="width: 200px"
                />
                <p style="font-size: 13px">
                  付款后加QQ 1204505056
