<template>
  <div class="BasicInfo">
    ...
    >
        ...
        <el-col :span="9">
          <el-form-item label="进口扬程算法">
            <el-row>
              <el-col :span="18">
                <el-select
                  v-model="TableInfoObj.jinkouyangchengsuanfa"
                  clearable
                  placeholder="请选择"
                >
                  <el-option
      ...
      <!--             <el-col :span="8">
              <el-form-item label="额度转速" label-width="70px">
                <el-input v-model="TableInfoObj.n" style="width:203px">
        ...
        <el-col :span="2" style="margin-top:100px">
          <el-popover placement="left" width="400" trigger="click">
            <h4 style="text-align:center">水的汽化压力和密度对照表</h4>
            <el-table
              ref="singleTable"
              :data="defaultObj.gridData"
              height="300"
              border
              highlight-current-row
              @current-change="handleCurrentChange"
            >
              <el-table-column property="centigrade" label="温度℃" align="center" />
              <el-table-column property="Pa" label="压力Pa" align="center" />
              <el-table-column property="density" label="密度kg/m3" align="center" />
            </el-table>
            <el-button slot="reference" type="primary" plain>选择</el-button>
          </el-popover>
        </el-col>
        <el-col :span="6">
          <el-form-item label="汽化压力">
            <el-input v-model="TableInfoObj.qihuayali" style="width:232px">
              <template slot="append">Pa</template>
            </el-input>
          </el-form-item>
          <el-form-item label="水的密度">
            <el-input v-model="TableInfoObj.shuidemidu" style="width:232px">
              <template slot="append">kg/m3</template>
            </el-input>
          </el-form-item>

          <el-form-item label="进口测压处管径" label-width="110px">
            <el-input v-model="TableInfoObj.d1" style="width:192px">
              <template slot="append">mm</template>
            </el-input>
          </el-form-item>
          <el-form-item label="出口测压处管径" label-width="110px">
            <el-input v-model="TableInfoObj.d2" style="width:192px">
              <template slot="append">mm</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-form-item label="进口压力表中心到基准面高度">
        <el-input v-model="TableInfoObj.z1">
          <template slot="append">mm</template>
        </el-input>
      </el-form-item>

      <el-form-item label="出口压力表中心到基准面高度">
        <el-input v-model="TableInfoObj.z2">
          <template slot="append">mm</template>
        </el-input>
      </el-form-item>

      <el-form-item label="进口扬程修正系数" style="margin-left:55px">
        <el-input v-model="TableInfoObj.c1" />
      </el-form-item>

      <el-form-item label="出口扬程修正系数">
        <el-input v-model="TableInfoObj.c2" />
      </el-form-item>

      <el-form-item label="进口扬程损失修正系数">
        <el-input v-model="TableInfoObj.c3" />
      </el-form-item>

      <el-form-item label="进口扬程损失修正系数">
        <el-input v-model="TableInfoObj.c4" />
      </el-form-item>
 -->
      <!-- </el-row> -->
    </el-form>
