      ...
      <el-card class="box-card">
        ...
        >
          ...
          <el-row :gutter="20">
            <el-col :span="row1">
              <!--触发事件-->
              <!--              <el-form-item :label="$translateTitle('rule.TriggerEvent')">-->
              <!--                <el-select-->
              <!--                  v-model="formInline.region"-->
              <!--                  :placeholder="$translateTitle('rule.TriggerEvent')"-->
              <!--                  @change="selectRegion"-->
              <!--                >-->
              <!--                  <el-option-->
              ...
              <!--                  <div class="code">-->
              <!--                    <code style="font-size: 12px">{{ client.join(',') }}</code>-->
              <!--                  </div>-->
              <!--                  <p>-->
              ...
              <!--                  </p>-->
              <!--                  <div class="code">-->
              <!--                    当前版本取消对 payload 的自动 JSON 解码，选择 payload-->
              <!--                    中的字段请使用 json_decode 解码，如 SQL 示例。-->
              <!--                  </div>-->
