export default [
      ...
      attrs: {
        config: {
          ...
          remoteMethod: {
            ...
            tip: '具体可查看文档：<a target="_blank" href="https://www.yuque.com/chaojie-vjiel/vbwzgu/rgenav#0GZqL" class="el-link el-link--primary">点击查看</a>',
          },
          loadingText: {
            type: 'input',
            label: '远程加载时显示的文字',
  ...
  },
  {
    ...
    sort: 12,
    config: {
      url: 'https://element.eleme.cn/#/zh-CN/component/time-picker#ren-yi-shi-jian-dian',
      attrs: {
        config: {
          placeholder: {
            type: 'input',
