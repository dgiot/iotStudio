...
for d in [
    ...
    {"objectId":"meter_main","devaddr":"meter_main","name":"主变压器电表","device_type":"meter","ip":"127.0.0.1","protocol":"iec104","isEnable":True,"status":"online","basedata":{"manufacturer":"威胜","model":"DTSD341"},"tenant_id":"default"},
