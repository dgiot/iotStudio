...
print("=== 3. List OPC Servers on 192.168.10.23 ===")
print(ps32("""
try {
    $list = New-Object -ComObject 'OPC.ServerList.1'
    $servers = $list.List('192.168.10.23')
    Write-Host ('Servers on 192.168.10.23: ' + $servers)
} catch {
    Write-Host ('FAIL: ' + $_.Exception.Message)
}
"""))
...
try {
    ...
    $srv.Connect('RSLinx OPC Server', '192.168.10.23')
...
try {
    ...
    $servers = @(
        @{Name='RSLinx OPC Server'; Host='192.168.10.23'},
        @{Name='RSLinx OPC Server'; Host='192.168.10.23'},
        @{Name='RSLinx OPC Server'; Host='192.168.10.23'},
