...
def seed_users():
    ...
    users = [
        ...
        {"username": "dgiot", "password": "dgiot123", "role": "admin"},
...
def seed_channels():
    ...
    channels = [
        {"device_id": "ch_youyeyun", "device_name": "🛢 油液监测", "protocol": "http_rest",
         "device_type": "sensor", "tenant_id": "oil-monitor",
         "comm_params": {"host": "youyeyun.com", "port": 443, "vendor": "youyeyun"}},
        ...
        {"device_id": "ch_vib", "device_name": "📊 声振温", "protocol": "http_rest",
         ...
         "comm_params": {"host": "127.0.0.1", "port": 8500, "vendor": "zhiwei_phm"}},
