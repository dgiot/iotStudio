...
PCAP_PACKETS = [
    ...
    {"proto":"A11","dir":"RX","src":"130:8889","dst":"131:58646","sz":117,"msg":"0x0000","hex":"5a5a730000003e0000000000020000000004000000340000008719000007bd6950...","desc":"LegacyComm二次封装"},
    # Modbus 帧
    ...
    # OPC DA 帧
    {"proto":"OPC-DA","dir":"RX","src":"192.168.10.23:58648","dst":"131:49778","sz":1460,"msg":"DCOM","hex":"05000003100000008c080000b8760200640800000100030002ac...","desc":"RSLinx OPC DA Request"},
    {"proto":"OPC-DA","dir":"RX","src":"192.168.10.23:3514","dst":"131:135","sz":120,"msg":"Bind","hex":"05000b03100000007800280066020000d016d016...","desc":"DCOM对象绑定 — RSLinx"},
]

# ===== 设备数据 =====
DEVICE_EVENTS = [
    {"device":"DEVICE_ID_PLACEHOLDER_WELL-01","point":"最大载荷","value":86.07,"unit":"kN"},
    {"device":"DEVICE_ID_PLACEHOLDER2_WELL-02","point":"最大下行电流","value":15.28,"unit":"A"},
    {"device":"DEVICE_ID_PLACEHOLDER2_WELL-02","point":"最小载荷","value":33.53,"unit":"kN"},
    {"device":"DEVICE_ID_PLACEHOLDER2_WELL-02","point":"最大上行电流","value":10.69,"unit":"A"},
    {"device":"DEVICE_ID_PLACEHOLDER2_WELL-02","point":"最大载荷","value":41.31,"unit":"kN"},
]
...
def status_pusher(client):
    ...
    publish(client, {
        ...
        "io_server": "192.168.10.131",
        "processes": {"IoProject":1,"IOMan":36,"IoMonitor":1,"LegacyComm":1,"IoCommit":7},
        "data_sources": 9,
...
if __name__ == "__main__":
    ...
    print(f"Agent: dgiot_lite | IO Server: 192.168.10.131")
