...
数据源: DQYTPROD @ 11.66.12.129:1521/orcl
中继:    WIN-NJ7VP96R2NM (11.66.12.131) WinRM → VBS/ADO → Oracle
...
@dataclass
class OracleConfig:
    host: str = "11.66.12.131"
    port: int = 5985
    username: str = "administrator"
    password: str = r"GKYWB-5991792$1c8k"
    oracle_uid: str = "DQYTPROD"
    oracle_pwd: str = "DQYTA11_pass"
    oracle_dsn: str = "11.66.12.129/orcl"
    timeout: int = 30
...
'''
    ...
    def parse_point_path(self, point_longname: str) -> dict:
        """
        解析 POINT_LONGNAME: /CY1C8K/B1V354V611/JD010804B1V354V611GYS
        → {site, well, station, point_code}

        本体映射:
            CY1C8K    → Site    (采油一厂八矿)
            B1V354V611 → Device  (井号)
            JD010804   → Station (计量间)
            GYS/ZYG... → Point   (测点类型)
        """
        ...
        if len(parts) >= 3:
            ...
            if well and station_point.startswith(well):
                ...
                # 以 JD 开头的是计量间编号
                result['station'] = station_point[:8]  # JD010804
