...
数据路径:
  本机 → WinRM(11.66.12.131:5985) → cscript 32位 → ADO → Oracle(11.66.12.129:1521)
"""
...
# ═══════════════════ 配置 ═══════════════════
WINRM_HOST = "11.66.12.131"
WINRM_PORT = 5985
WINRM_USER = "administrator"
WINRM_PASS = r"GKYWB-5991792$1c8k"
ORACLE_UID = "DQYTPROD"
ORACLE_PWD = "DQYTA11_pass"
ORACLE_DSN = "11.66.12.129/orcl"
...
def main():
    ...
    print("=" * 55)
    print(f"""
  数据源:   大庆采油厂 Oracle 11g @ {ORACLE_DSN}
