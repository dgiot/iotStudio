"""
CommBridge probe v5 - Registration/login patterns + netsh capture
"""
import winrm, os, sys, base64, re

os.environ['NO_PROXY']='11.66.12.131,11.*,172.*'
s=winrm.Session('http://11.66.12.131:5985/wsman',auth=('administrator','GKYWB-5991792$1c8k'),transport='ntlm',read_timeout_sec=120)
