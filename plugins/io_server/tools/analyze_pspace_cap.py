...
r = s.run_cmd(r'netsh trace convert C:\Users\Administrator\pspace_cap2.etl dump=txt 2>&1')
print(r.std_out.decode('gbk', errors='ignore').strip()[:300])

# Read the text dump — look for data frames
print("\n=== Extracting pSpace frames ===")
r = s.run_cmd(r'type C:\Users\Administrator\pspace_cap2.txt 2>nul')
