...
hosts = sys.argv[1:] if len(sys.argv) > 1 else ["172.23.9.3", "172.23.9.23"]
...
# Run
r = s.run_cmd(r'C:\Users\Administrator\opc_portable\python.exe C:\Users\Administrator\opc_br.py 172.23.9.3')
