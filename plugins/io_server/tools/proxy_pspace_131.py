"""
在 131 上部署 TCP 代理，截获 pSpace 协议帧
...
import json
with open(r"C:\Users\Administrator\pspace_frames.json", "w") as f:
...
r = s.run_ps(f"[IO.File]::WriteAllBytes('C:\\Users\\Administrator\\proxy_pspace.py', [Convert]::FromBase64String('{b64}'))")
time.sleep(0.5)

# Run the proxy (它只会接受1个连接用于测试)
print("Starting proxy on 131...")
r = s.run_cmd('C:\\Users\\Administrator\\opc_portable\\python.exe C:\\Users\\Administrator\\proxy_pspace.py')
...
print("\n=== pSpace frames captured ===")
r = s.run_cmd('type C:\\Users\\Administrator\\pspace_frames.json 2>nul')
