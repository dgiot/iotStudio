...
class OracleReader:
    ...
    def query(self, sql, label="q"):
        ...
        vbs = VBS_TEMPLATE.format(timeout=30, pwd='DQYTA11_pass', uid='DQYTPROD',
                                   dsn='11.66.12.129/orcl', sql_blocks=block)
