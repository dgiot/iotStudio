...
os.environ['no_proxy']='11.66.12.131,11.*,172.*'
import winrm
s = winrm.Session('http://11.66.12.131:5985/wsman', auth=('administrator',r'GKYWB-5991792$1c8k'), transport='ntlm', read_timeout_sec=60)

# Simple test VBS
vbs = 'Dim conn,rs\r\nOn Error Resume Next\r\n'
vbs += 'Set conn = CreateObject("ADODB.Connection")\r\n'
vbs += 'conn.ConnectionTimeout = 30 : conn.CommandTimeout = 30\r\n'
vbs += 'conn.Open "Provider=OraOLEDB.Oracle.1;Password=DQYTA11_pass;User ID=DQYTPROD;Data Source=11.66.12.129/orcl"\r\n'
