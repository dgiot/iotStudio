...
# 2. Try strings on LegacyComm.pdb for function names
ps2 = r'''
$ErrorActionPreference="SilentlyContinue"
# Use findstr to search for protocol-related strings
$targets = @(
    "E:\IO ServerOnLine\LegacyComm.pdb",
    "E:\IO ServerOnLine\LegacyComm.exe",
    "E:\IO ServerOnLine\LegacyComm-.exe",
...
# 4. Check what LegacyComm - command line arguments / help
ps4 = r'''
$ErrorActionPreference="SilentlyContinue"
Write-Host "=== LegacyComm command line help === "
# Run with --help or /?
try {
    $pinfo = New-Object System.Diagnostics.ProcessStartInfo
    $pinfo.FileName = "E:\IO ServerOnLine\LegacyComm.exe"
...
} catch { Write-Host "Cannot run LegacyComm --help" }
try {
    $pinfo = New-Object System.Diagnostics.ProcessStartInfo
    $pinfo.FileName = "E:\IO ServerOnLine\LegacyComm.exe"
    $pinfo.RedirectStandardError = $true
    ...
    $p.WaitForExit(2000)
    if ($out) { Write-Host $out }
} catch { Write-Host "Cannot run LegacyComm /?" }
'''
run_ps(ps4, "LegacyComm command line")
