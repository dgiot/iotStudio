...
stats = {
    'total_packets': 0,
    'total_53001': 0,
    'dir_cb_to_rtu': 0,   # LegacyComm -> RTU (src:53001)
    'dir_rtu_to_cb': 0,   # RTU -> LegacyComm (dst:53001)
...
lines.append(f"  LegacyComm -> RTU (src:53001): {stats['dir_cb_to_rtu']}")
lines.append(f"  RTU -> LegacyComm (dst:53001): {stats['dir_rtu_to_cb']}")
