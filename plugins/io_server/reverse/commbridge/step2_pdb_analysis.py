"""
Step 2: PDB Symbol Analysis - Extract and classify symbols from CommBridge.pdb
"""
...
def analyze_pdb():
    ...
    pdb_file = os.path.join(LOCAL_DIR, "CommBridge.pdb")
...
def analyze_exe_pdb():
    ...
    for f in os.listdir(LOCAL_DIR):
        if f.endswith('.pdb') and f != 'CommBridge.pdb':
