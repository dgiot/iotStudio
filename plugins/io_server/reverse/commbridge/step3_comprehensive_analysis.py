"""
Step 3: Comprehensive static analysis of CommBridge.exe
...
def analyze_pe(filepath):
    """Analyze PE structure of CommBridge.exe."""
    results = {
        'sections': [],
        'imports': {},
        'exports': [],
...
def main():
    print("=" * 60)
    print("Step 3: Comprehensive Static Analysis of CommBridge.exe")
    print("=" * 60)

    exe_path = os.path.join(LOCAL_DIR, "CommBridge.exe")
    if not os.path.exists(exe_path):
        # Try alt name
        for f in os.listdir(LOCAL_DIR):
            if 'CommBridge' in f and f.endswith('.exe'):
