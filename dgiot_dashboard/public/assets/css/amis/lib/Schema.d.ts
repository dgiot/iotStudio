 ...
 *     }
 */
export declare type SchemaClassName = string | {
...
export declare type SchemaApi = string | SchemaApiObject;
/**
 ...
 */
export declare type SchemaReload = string;
/**
 * 页面跳转地址，支持相对地址。
 */
export declare type SchemaRedirect = string;
/**
 * 支持两种语法，但是不能混着用。分别是：
 *
 ...
 */
export declare type SchemaTpl = string;
/**
 * 初始数据，设置得值可用于组件内部模板使用。
 */
export declare type SchemaDefaultData = {
    [propName: string]: any;
};
/**
 * 用来关联 json schema 的，不用管。
 */
export declare type SchemaSchema = string;
/**
 * iconfont 里面的类名。
 */
export declare type SchemaIcon = string;
export declare type SchemaTokenizeableString = string;
export declare type SchemaUrlPath = SchemaTokenizeableString;
export declare type SchemaTooltip = string | {
    /**
     * 标题
     */
    title?: string;
 ...
 */
export declare type SchemaMessage = {
    /**
     * 获取失败时的提示
     */
    fetchFailed?: string;
...
export declare type SchemaFunction = string | Function;
...
export declare type RootSchema = PageSchema;
