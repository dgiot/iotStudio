...
var VBox = /** @class */ (function (_super) {
    ...
    VBox.prototype.renderCell = function (row, key) {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)(ns + "Vbox-cell", row.cellClassName) }, this.renderChild("row/" + key, row)));
    };
    VBox.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, rows = _a.rows, ns = _a.classPrefix;
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)(ns + "Vbox", className) }, Array.isArray(rows)
