    ...
    var FormOptionsItem = /** @class */ (function (_super) {
        ...
        function FormOptionsItem(props) {
            ...
            if (formItem) {
                ...
                _this.reaction = (0, mobx_1.reaction)(function () { return JSON.stringify([formItem.loading, formItem.filteredOptions]); }, function () { return _this.mounted && _this.forceUpdate(); });
        ...
        FormOptionsItem.prototype.componentWillUnmount = function () {
            ...
            (_c = this.reaction) === null || _c === void 0 ? void 0 : _c.call(this);
        };
