...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, value = _a.value, active = _a.active, name = _a.name, className = _a.className, onChange = _a.onChange, disabled = _a.disabled, placeholder = _a.placeholder, mini = _a.mini, __ = _a.translate;
