...
declare const _default: {
    ...
    }, keyof ThemeProps> & import("../../theme").ThemeOutterProps) | Readonly<Omit<Omit<ConditionItemProps, keyof LocaleProps> & {
        locale?: string | undefined;
        translate?: ((str: string, ...args: any[]) => string) | undefined;
    ...
    ComposedComponent: React.ComponentType<{
        new (props: (Omit<ConditionItemProps, keyof LocaleProps> & {
            locale?: string | undefined;
            translate?: ((str: string, ...args: any[]) => string) | undefined;
        }) | Readonly<Omit<ConditionItemProps, keyof LocaleProps> & {
            locale?: string | undefined;
            translate?: ((str: string, ...args: any[]) => string) | undefined;
        }>): {
            render(): JSX.Element;
