...
export declare class QueryBuilder extends React.Component<ConditionBuilderProps> {
    config: {
        valueTypes?: ("value" | "formula" | "field" | "func")[] | undefined;
...
declare const _default: {
    ...
    }, keyof ThemeProps> & import("../../theme").ThemeOutterProps) | Readonly<Omit<Omit<ConditionBuilderProps, keyof LocaleProps> & {
        locale?: string | undefined;
        translate?: ((str: string, ...args: any[]) => string) | undefined;
    ...
    ComposedComponent: React.ComponentType<{
        new (props: (Omit<ConditionBuilderProps, keyof LocaleProps> & {
            locale?: string | undefined;
            translate?: ((str: string, ...args: any[]) => string) | undefined;
        }) | Readonly<Omit<ConditionBuilderProps, keyof LocaleProps> & {
            locale?: string | undefined;
            translate?: ((str: string, ...args: any[]) => string) | undefined;
        }>): {
            render(): JSX.Element;
