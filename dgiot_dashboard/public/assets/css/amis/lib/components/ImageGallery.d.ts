...
declare const _default: {
    ...
    }, keyof ThemeProps> & import("../theme").ThemeOutterProps) | Readonly<Omit<Omit<ImageGalleryProps, keyof LocaleProps> & {
        locale?: string | undefined;
        translate?: ((str: string, ...args: any[]) => string) | undefined;
    ...
    ComposedComponent: React.ComponentType<{
        new (props: (Omit<ImageGalleryProps, keyof LocaleProps> & {
            locale?: string | undefined;
            translate?: ((str: string, ...args: any[]) => string) | undefined;
        }) | Readonly<Omit<ImageGalleryProps, keyof LocaleProps> & {
            locale?: string | undefined;
            translate?: ((str: string, ...args: any[]) => string) | undefined;
        }>): {
            render(): JSX.Element;
