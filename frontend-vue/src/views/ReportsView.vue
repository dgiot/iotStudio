...
const loadRank = () => {
  ...
  const base = [
    ...
    { device: '10.0.0.20 RSLinx OPC', proto: 'OPC', daily: 14500, weekly: 101500, monthly: 435000 },
    { device: '10.0.0.20 PLC-S7', proto: 'OPC', daily: 11200, weekly: 78400, monthly: 336000 },
